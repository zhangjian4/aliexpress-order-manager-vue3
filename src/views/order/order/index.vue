<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="orderList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="订单产品-属性" align="center" prop="goodsProperties" />
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="orderRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="订单产品-属性" prop="goodsProperties">
          <el-input v-model="form.goodsProperties" placeholder="请输入订单产品-属性" />
        </el-form-item>
        <el-form-item label="订单产品-数量" prop="goodsCount">
          <el-input v-model="form.goodsCount" placeholder="请输入订单产品-数量" />
        </el-form-item>
      </el-form>
      <template #footer>
